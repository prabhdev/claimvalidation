...
public class SwaggerConfig {
    ...
    public Docket api() {
        Docket docket =  new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors.basePackage("com.patient.val"))
                .build();
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("Patient Validation Service API").description("Reference for developers")
